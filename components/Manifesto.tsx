 ...
 */
const TEXT =
  "Most local businesses are brilliant at what they do and let down by a website that isn't. We find the *gap*, show you exactly what *better* looks like, and build it *fast* at a *fixed price*.";
